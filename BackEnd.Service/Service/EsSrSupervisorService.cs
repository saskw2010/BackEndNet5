...
{
  public class EsSrSupervisorService : IEsSrSupervisorService
  {
    ...
    public EsSrSupervisorService(IUnitOfWork unitOfWork,
    ...
    public async Task<Result> createUserForSupervisorAsync()
    {
      try
      {
        List<EsSrSupervisor> EsSrSupervisors = _unitOfWork.EsSrSupervisorRepository.Get().ToList();
        foreach (var item in EsSrSupervisors)
        {
